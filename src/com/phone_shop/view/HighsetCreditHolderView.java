 ...
 * @author NisalSP9
 */
public class HighsetCreditHolderView extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public HighsetCreditHolderView(java.awt.Frame parent, boolean modal) {
        //super(parent, modal);
        initComponents();
        ...
        try {
            ...
            Logger.getLogger(HighsetCreditHolderView.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Highest Credit Holder");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        for (int i = 0; i < model.getRowCount(); i++) {
            ...
            dataset.setValue((String) model.getValueAt(i, 1) + " -> " + model.getValueAt(i, 0), (java.math.BigDecimal) model.getValueAt(i, 2));

        }
        freeChart = ChartFactory.createPieChart("Highest Credit Holder", dataset, true, true, true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HighsetCreditHolderView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                HighsetCreditHolderView dialog = new HighsetCreditHolderView(new javax.swing.JFrame(), true);
    ...
    private void updateTable() throws SQLException, ClassNotFoundException {
        ...
        ResultSet rst = rc.highestCreditHolder();
