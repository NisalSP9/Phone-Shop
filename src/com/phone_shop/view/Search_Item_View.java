 ...
 * @author NisalSP9
 */
public final class Search_Item_View extends javax.swing.JDialog {

    public Search_Item_View(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        autoFillCB();
        trackEnterPressed();
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(-20, -16, 580, 730);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Search_Item_View.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Search_Item_View dialog = new Search_Item_View(new javax.swing.JFrame(), true);
                ...
                if ( evt.getKeyCode() == 40 || evt.getKeyCode() == 38 || evt.getKeyCode()== KeyEvent.VK_BACK_SPACE ||evt.getKeyCode() >= 65 || evt.getKeyCode() <= 90 && evt.getKeyCode() == KeyEvent.VK_ENTER && Letter != null) {
                    ...
                    if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
                        ...
                        try {
                            ...
                            JOptionPane.showMessageDialog(Search_Item_View.this, "Sorry...!");
                            resetButton.doClick();
                    ...
                    JOptionPane.showMessageDialog(Search_Item_View.this, "Wrong Input...!");
                    itemCB.removeAllItems();
    ...
    public void itemInfor() {
        ...
        try {
            ...
            try {
                ...
                itemCB.setFocusable(false);
                JOptionPane.showMessageDialog(Search_Item_View.this, "Can't Find...!");
                resetButton.doClick();
                itemCB.setFocusable(true);
            }
