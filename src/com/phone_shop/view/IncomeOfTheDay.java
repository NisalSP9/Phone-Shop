 ...
 * @author NisalSP9
 */
public class IncomeOfTheDay extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public IncomeOfTheDay(java.awt.Frame parent, boolean modal) {
        //super(parent, modal);
        initComponents();
        ...
        try {
            ...
            Logger.getLogger(IncomeOfTheDay.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Income Reports");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IncomeOfTheDay.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                IncomeOfTheDay dialog = new IncomeOfTheDay(new javax.swing.JFrame(), true);
    ...
    private void updateTable(String date) throws SQLException, ClassNotFoundException {
        ...
        rst = rc.incomeOfTheDayForAllPayments(date);

        if (rst == null) {
            
            JOptionPane.showMessageDialog(IncomeOfTheDay.this,"No Income For Given Date");
        } else {
