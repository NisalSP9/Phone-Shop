 ...
 * @author NisalSP9
 */
public class MostChequeReceivingBank extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public MostChequeReceivingBank(java.awt.Frame parent, boolean modal) {
        //super(parent, modal);
        initComponents();
        ...
        try {
            ...
            Logger.getLogger(MostChequeReceivingBank.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Most Cheque Receiving Bank");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        for (int i = 0; i < model.getRowCount(); i++) {
            ...
            dataset.setValue((String) model.getValueAt(i, 0),(Long) model.getValueAt(i, 1));

        }
        freeChart = ChartFactory.createPieChart("Most Cheque Receiving Bank", dataset, true, true, true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MostChequeReceivingBank.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MostChequeReceivingBank dialog = new MostChequeReceivingBank(new javax.swing.JFrame(), true);
    ...
    private void updateTable() throws SQLException, ClassNotFoundException {
        ...
        ResultSet rst = rc.mostChequeReceivingBank();
