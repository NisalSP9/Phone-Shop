 ...
 * @author NisalSP9
 */
public class IncomeOfTheDayRC extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public IncomeOfTheDayRC(java.awt.Frame parent, boolean modal) {
        //super(parent, modal);
        initComponents();
        ...
        try {
            ...
            Logger.getLogger(IncomeOfTheDayRC.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Income Reports Retail Sales ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IncomeOfTheDayRC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                IncomeOfTheDayRC dialog = new IncomeOfTheDayRC(new javax.swing.JFrame(), true);
    ...
    private void updateTable(String date) throws SQLException, ClassNotFoundException {
        ...
        rst = rc.incomeOfTheDayForAllPaymentsRC(date);

        if (rst == null) {
            
            JOptionPane.showMessageDialog(IncomeOfTheDayRC.this,"No Income For Given Date");
        } else {
