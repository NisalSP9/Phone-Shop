 ...
 * @author NisalSP9
 */
public class MostValuableCustomer extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public MostValuableCustomer(java.awt.Frame parent, boolean modal) {
        //super(parent, modal);
        initComponents();
        ...
        try {
            ...
            Logger.getLogger(MostValuableCustomer.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Most Valuable Customer");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        for (int i = 0; i < model.getRowCount(); i++) {
            ...
            dataset.setValue((String) model.getValueAt(i, 0),(long)model.getValueAt(i, 2));

        }
        freeChart = ChartFactory.createPieChart("Most Valuable Customer", dataset, true, true, true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MostValuableCustomer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MostValuableCustomer dialog = new MostValuableCustomer(new javax.swing.JFrame(), true);
    ...
    private void updateTable() throws SQLException, ClassNotFoundException {
        ...
        ResultSet rst = rc.mostValuableCustomer();
