 ...
 * @author NisalSP9
 */
public class MostValuableItemReport extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public MostValuableItemReport(java.awt.Frame parent, boolean modal) {
        //super(parent, modal);
        initComponents();
        ...
        try {
            ...
            Logger.getLogger(MostValuableItemReport.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Most Valuable Item");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        freeChart = ChartFactory.createPieChart("Most Valuable Items", dataset, true, true, true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MostValuableItemReport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MostValuableItemReport dialog = new MostValuableItemReport(new javax.swing.JFrame(), true);
    ...
    private void updateTable() throws SQLException, ClassNotFoundException {
        ...
        ResultSet rst = rc.mostVaulebleItem();
