...
CREATE TABLE `paymenttable` (
  ...
  PRIMARY KEY (`Order_ID_Pay`,`customer_ID`),
  KEY `cust_ID_idx` (`customer_ID`),
  CONSTRAINT `customer_ID` FOREIGN KEY (`customer_ID`) REFERENCES `ordertable` (`cust_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `Order_ID_Pay` FOREIGN KEY (`Order_ID_Pay`) REFERENCES `ordertable` (`orderID`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2016-03-27  0:34:41
